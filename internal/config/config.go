...
var (
	PostgresConnection ConfigKey = "pg_dsn"
	ApiKey             ConfigKey = "apikey"
	RedisConnection    ConfigKey = "redis_connection"
	Port               ConfigKey = "port"
	ExchangeRateTTL    ConfigKey = "exchange_rate_ttl"
)
...
func uploadConfigFromYaml() ConfigFile {
	...
	if valuesFile == "" {
		valuesFile = "./k8s/values_local.yaml"
	}
